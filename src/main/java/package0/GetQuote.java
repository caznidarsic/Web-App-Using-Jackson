 ...
 * GetQuote class
 * 
 * The GetQuote class is called by the EndPoints
...
public class GetQuote {
	...
	public static String getQuote(String hikeName, String date, int duration, int inputHikers) {
		...
		BookingDay bookingDay = new BookingDay(Integer.parseInt(date.substring(0, 4)), Integer.parseInt(date.substring(5, 7)), Integer.parseInt(date.substring(8, 10)));
